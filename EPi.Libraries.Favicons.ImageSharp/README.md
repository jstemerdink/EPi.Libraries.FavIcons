...
Resizing service for use in EPi.Libraries.Favicons that uses [ImageSharp](https://docs.sixlabors.com/articles/imagesharp/index.html), which is included with the CMS, to resize your images.
